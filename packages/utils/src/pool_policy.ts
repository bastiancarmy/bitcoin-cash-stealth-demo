// packages/utils/src/pool_policy.ts
//
// Shared pool policy helpers used across packages.
// Keeps pool-shards and pool-hash-fold from depending on each other.

import { sha256 } from './hash.js';
import { concat, hexToBytes, reverseBytes, uint32le } from './bytes.js';

export const DUST_SATS = 546n;

// Hash-fold version “protocol” constants belong in shared utils.
